      ...
      <div className="flex flex-col items-center py-3 text-center sm:py-6">
        <div className="flex items-baseline justify-center gap-2">
          ...
          <span
            ...
            style={{ fontFamily: '"Google Sans Variable", var(--font-sans-v2), system-ui, sans-serif', fontSize: 48, lineHeight: 1.02, letterSpacing: "-0.02em" }}
          >
            {display}
          </span>
        </div>
        ...
        {contacts.length === 0 ? (
          ...
          <div className="overflow-hidden rounded-[28px] border border-[#15300c]/15 bg-white/60 backdrop-blur-sm">
            {contacts.map((c, i) => (
              ...
              >
                <span className="flex size-9 shrink-0 items-center justify-center rounded-full bg-[#CAFFB8] text-[12px] font-[800] text-[#15300c]" style={{ fontFamily: '"TWK Everett", var(--font-display-v2), system-ui, sans-serif' }}>
                  {contactInitials(c)}
                </span>
    ...
    <div className="space-y-5">
      ...
      <div className="py-2 text-center">
        <div
          ...
          style={{ fontFamily: '"Google Sans Variable", var(--font-sans-v2), system-ui, sans-serif', fontSize: 40, letterSpacing: "-0.02em", lineHeight: 1.02 }}
        >
          {formatUsd(amountUsd)}
        </div>
  ...
  return (
    <div className="flex flex-col items-center pt-4 text-center">
      ...
      <div
        ...
        style={{ fontFamily: '"Google Sans Variable", var(--font-sans-v2), system-ui, sans-serif', fontSize: 44, letterSpacing: "-0.02em" }}
      >
        {formatUsd(amountUsd)}
      </div>
      {to && (
...
function FailureStep({
  ...
  return (
    <div className="flex flex-col items-center pt-6 text-center">
      ...
      <h2
        className="text-[26px] font-[500] text-[#15300c]"
